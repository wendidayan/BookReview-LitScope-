        ...
        <section style="margin-top: 46px">
            ...
            >
                ...
                <div class="offcanvas-body">
                    <div class="col-xl-3 col-xxl-3" style="width: inherit">
                        <div
                            class="card d-xxl-flex justify-content-xxl-center"
                            style="width: initial; border-radius: 20px"
                        >
                        ...
                        >
                            ...
                            >
                                ...
                                <div style="padding-left: 20px">
                                    <div class="align-content-center">
                                        <div
                                            class="d-flex align-items-xl-center"
                                        >
                                            <i
                                                class="fas fa-star"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    >
                        ...
                        >
                            ...
                            <option value="">Sort by latest</option></select
                        ><label
                            class="form-label d-xl-flex align-items-xl-center"
                            style="margin-bottom: 1px; padding-bottom: 0px"
                            >Show</label
                        ><select
                            class="d-xxl-flex"
                            style="border-style: none; height: 30px"
                        >
                            <option value="undefined">12</option>
                ...
                <div class="row">
                    <div
                        class="col-lg-3 col-xl-3 col-xxl-3 d-none d-lg-inline d-xl-inline d-xxl-inline"
                    >
                        <div
                            class="card d-xxl-flex justify-content-xxl-center"
                            style="
