...
<html data-bs-theme="light" lang="en">
    ...
    <body>
        ...
        <!-- End: Navbar Centered Links --><!-- Start: Hero Parallax -->
        <section>
            ...
            <div
                ...
                style="
                    ...
                    background: linear-gradient(
                            28deg,
                            #ffffff,
                            rgba(255, 255, 255, 0.8811141304347826) 31%,
                            rgba(255, 255, 255, 0) 69%
                        ),
                        url('/assets/img/heroSEC.jpg?h=3a2e11e5ae9d99863191aad52bf7d602')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-3 col-xl-3 col-xxl-3">
                        <div
                            class="card bg-body-secondary bg-opacity-75 d-xxl-flex justify-content-xxl-center"
                            style="
                                width: initial;
                                border-radius: 20px;
                                border-style: none;
                        ...
                        >
                            ...
                            >
                                <h3
                                    class="d-xl-flex d-xxl-flex justify-content-xl-start justify-content-xxl-start align-items-xxl-center card-title"
                                ...
                                <div class="align-content-center">
                                    <div
                                        class="col d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-lg-center justify-content-xl-center justify-content-xxl-center"
                                    ...
                                    >
                                        ...
                                        /></picture>
                                        <div
                                            class="text-start d-flex flex-column justify-content-xxl-center"
                                            style="
                                                margin-left: 15px;
                                                margin-right: 15px;
                                            "
...
<!--
    ...
    <div class="row d-flex justify-content-start flex-wrap">
        ...
        <div class="container">
            <div
                class="row gy-4 row-cols-2 row-cols-md-4 d-xxl-flex"
                style="margin-top: -6px"
            >
                <div class="col">
                    <div
                        class="text-center border-1 d-flex flex-column justify-content-center align-items-center py-3"
                        style="
                            border-radius: 20px;
                    ...
                    >
                        ...
                        <div class="px-3" style="color: rgb(55, 58, 60)">
                ...
                <div class="col">
                    ...
                    >
                        ...
                        <div
                            ...
                            style="
                                color: rgb(55, 58, 60);
                                border-color: rgb(47, 26, 26);
                            "
                        >
                            <h2 class="fw-bold mb-0">89</h2>
                            <p class="mb-0" style="color: rgb(55, 58, 60)">
                                authors
                            </p>
                        </div>
                    </div>
