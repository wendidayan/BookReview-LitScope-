...
<html data-bs-theme="light" lang="en">
    ...
    <body>
        ...
        <nav
            class="navbar navbar-expand-md bg-body d-inline d-sm-inline d-md-none d-lg-none d-xl-none d-xxl-none py-3"
                            ...
                            <div class="dropdown-menu">
                                ...
                                ><a class="dropdown-item" href="#"
                                    ...
                                    >
                                        ...
                                        ></path>
                                        <path
                                            d="M12.331 9.5a1 1 0 0 1 0 1A4.998 4.998 0 0 1 8 13a4.998 4.998 0 0 1-4.33-2.5A1 1 0 0 1 4.535 9h6.93a1 1 0 0 1 .866.5M7 6.5c0 .828-.448 0-1 0s-1 .828-1 0S5.448 5 6 5s1 .672 1 1.5m4 0c0 .828-.448 0-1 0s-1 .828-1 0S9.448 5 10 5s1 .672 1 1.5"
                                        ></path></svg
                                    >Comedy</a
                                ><a class="dropdown-item" href="#"
                                    ><i
        ...
        <!-- End: Navbar With Button --><!-- Start: Navbar With Button -->
        <nav
            class="navbar navbar-expand bg-body d-none d-sm-none d-lg-none d-xl-none d-xxl-none py-3"
            style="padding-right: 104px; /*flex-wrap: block;*/"
        >
        ...
        <!-- End: Navbar With Button --><!-- Start: Navbar Centered Links -->
        <nav
            class="navbar navbar-expand-md bg-body d-none d-md-inline d-lg-inline d-xl-inline d-xxl-inline py-3"
            style="height: 40px; background: #334b35; border-width: 1px"
        >
            <div class="container">
                ...
                <div class="row d-sm-flex">
                    <div class="col-sm-12 col-md-5 col-lg-4 col-xl-3 col-xxl-3">
                        ...
                        >
                            <picture
                                ><img
                                    ...
                                    style="width: inherit; border-radius: 20px"
                                    width="252"
                                    height="373"
                            /></picture>
                        </div>
                        <div style="margin-top: 24px; margin-bottom: 24px">
                            <div
                                class="d-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                            ...
                            <h4
                                class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center"
                                style="margin-bottom: -1px; margin-top: 14px"
                            >
                                Rate this Book
                            </h4>
                            <!-- Start: reted -->
                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9 col-xxl-9" style="margin-top: 0px;">
    <div class="card border-1" style="border-radius: 20px; padding-left: 24px; padding-right: 24px;">
        <div class="card-body justify-content-evenly">
            <div style="margin-top: 15px;">
                ...
                <!-- Book Author -->
                <h4 style="margin-bottom: -1px; margin-top: 1px; padding-bottom: 0px;">
                    {{ $book->author }}
                </h4>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-borderless">
                    <tbody>
                        <tr>
                            <td style="width: 131.578px;">Genres</td>
                            <td>
                                @foreach ($book->genres as $genre)
                                    <a href="#" style="text-decoration: none; margin-right: 12px; color: rgb(0, 0, 0);">
                                        {{ $genre }}
                                    </a>
                                @endforeach
                            </td>
...
<div class="row">
    <div class="col" style="margin-top: 19px">
        <div class="card border-1" style="border-radius: 20px; border-style: none; padding-left: 0px; padding-right: 0px;">
            <div class="card-body justify-content-evenly" style="padding-left: 0px; padding-right: 0px">
                <div style="margin-top: 15px">
                    <ul class="nav nav-underline nav-justified" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1" style="color: rgb(0, 0, 0); font-size: 20px;">About the author</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2" style="color: rgb(0, 0, 0); font-size: 20px;">Reviews</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-3" style="color: rgb(0, 0, 0); font-size: 20px;">Similar Books</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="tab-1" style="padding: 30px 0px;">
                                    ...
                                    <div class="d-flex align-items-xl-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">
                                                <span style="color: rgb(112, 112, 112);">541&nbsp;books&nbsp;</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-dot" style="margin-left: 8px; margin-right: 8px;">
                                                    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
                                                </svg>
                                                <span style="color: rgb(112, 112, 112);">229k&nbsp;followers</span>
                                            </p>
                                        </div>
                                    </div>
                                    <p style="margin-top: 20px;">{{ $book->about_author }}</p>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const ratingInput = document.getElementById('rating'); // Hidden input to store the rating

        stars.forEach(star => {
            star.addEventListener('click', function () {
                // Remove the 'selected' class from all stars
                stars.forEach(star => star.style.color = 'gray'); // Reset all stars to gray
        ...
        <div class="modal fade" role="dialog" tabindex="-1" id="modal-1">
            ...
            >
                <div class="modal-content">
                    ...
                    >
                        <div style="width: auto" class="rateSec">
                            <div class="row">
                                <div
                                    class="col-xxl-12 d-flex"
                                    style="width: 604px"
                                >
                                    <label
                                        ...
                                        ><strong>Your rating</strong></label
                                    >
                                    <div
                                        class="d-flex align-items-xxl-center"
                                        style="
    ...
    function toggleReplyForm(commentId) {
        // Get the reply form element by its ID
