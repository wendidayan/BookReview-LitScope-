    ...
    <body>
        <section>
            <div class="row" style="height: fit-content">
                ...
                <!-- End: side panel --><!-- Start: ApproveBookColumn -->
                <div
                                                    ...
                                                    @foreach($pendingBooks as $book)
                                                        <tr>
                                                            ...
                                                            <div
                                                                ...
                                                                >
                                                                    <button
                                                                        class="btn btn-primary approve-button d-xl-flex d-xxl-flex justify-content-xl-center align-items-xl-center justify-content-xxl-center align-items-xxl-center me-2 py-0 px-0"
                                                                        type="button"
                                                                        data-id="{{ $book->id }}"
                                                                        style="
                                                                            border-radius: 11px;
                                                                    ...
                                                                    >
                                                                        <svg
                                                                            ...
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="icon icon-tabler icon-tabler-checkbox me-0"
                                                                            style="
                                                                                font-size: 20px;
                                                                            "
                                                                        >
                                                                    ...
                                                                    ><button
                                                                        class="btn btn-danger reject-button d-xl-flex d-xxl-flex justify-content-xl-center align-items-xl-center justify-content-xxl-center align-items-xxl-center py-0 px-0 me-0"
                                                                        type="button"
                                                                        data-id="{{ $book->id }}"
                                                                        style="
                                                                            border-radius: 11px;
                                                                    ...
                                                                    >
                                                                        <svg
                                                                            ...
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round"
                                                                            class="icon icon-tabler icon-tabler-trash-x me-0"
                                                                            style="
                                                                                font-size: 20px;
                                                                            "
                                                                        >
...
<script>
    $(document).ready(function() {
        $('.approve-button').click(function() {
            ...
            $.ajax({
                url: '/AdminAproveBook/approve-book/' + bookId,
                type: 'POST',
                data: {
        ...
        $('.reject-button').click(function() {
            var bookId = $(this).data('id');
            $.ajax({
                url: '/AdminAproveBook/reject-book/' + bookId,
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}' // Include CSRF token
                },
                ...
                error: function(xhr) {
                    alert('An error occurred while rejecting the book.');
                }
            });
        });
    });
