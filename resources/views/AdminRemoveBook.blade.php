                        ...
                        <div class="col pt-3">
                            ...
                            >
                                <div class="card-body px-5 py-5">
                                    ...
                                    <hr />
                                    <div class="table-responsive" style="height: 397.484px;">
    <table class="table">
        <thead>
            <tr>
                <th style="width: 149.906px; max-width: 149.906px;">Title&nbsp;</th>
                <th style="width: 149.906px; max-width: 149.906px;">Author/Writer</th>
                <th>About Author/Writer</th>
                <th>Description&nbsp;</th>
                <th style="width: 164.734px">Genre</th>
                <th style="width: 163.406px">Published&nbsp;<strong>Date&nbsp;</strong></th>
                <th style="width: 102.641px">Pages</th>
                <th style="width: 120.547px">Language&nbsp;</th>
                <th style="width: 85.812px"></th>
            </tr>
        </thead>
        <tbody>
            @foreach ($Books as $book)
                <tr>
                    <td style="max-width: 140.891px; width: 140.891px;">{{ $book->title }}</td>
                    <td style="max-width: 140.891px; width: 140.891px;">{{ $book->author }}</td>
                    <td style="width: 266.844px; max-width: 159.844px;">{{ $book->about_author }}</td>
                    <td style="width: 266.844px; max-width: 127.844px;">{{ $book->about }}</td>
                    <td style="width: 168.859px; max-width: 168.859px;">{{ $book->genres }}</td>
                    <td style="width: 157.984px; max-width: 157.984px;">{{ $book->published }}</td>
                    <td style="max-width: 102.641px;">{{ $book->format }}</td>
                    <td style="max-width: 123.656px; width: 123.656px;">{{ $book->language }}</td>
                    <td style="width: 99.1094px;">
                    <div class="btn-group" role="group">
                        <button class="btn btn-primary d-xl-flex d-xxl-flex justify-content-xl-center align-items-xl-center justify-content-xxl-center align-items-xxl-center py-0 px-0 me-0 delete-btn"
                                data-id="{{ $book->id }}"
                                type="button" style="border-radius: 11px; border-style: none; color: rgb(255, 255, 255); width: 38px; height: 33.1094px; background: #ff2618;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                 class="icon icon-tabler icon-tabler-trash-x me-0" style="font-size: 20px;">
